...
#define TIME_STEP 1.0 ////em segundos
#define NUM_ROBOTS 3

/*TOPICOS A SEREM MONITORADOS
/formation_center -> posicao e orientacao
/robotX/odom -> posicao e orientacao
/robotX_on_formation -> pos e orient (pos ideal)
/test_point -> goal intermediario, pos e orient

Inicia com /init_operation == true
Calcular tempo tambem, termina com /finished_operation == true
...
/// fonte: https://stackoverflow.com/questions/17223096/outputting-date-and-time-in-c-using-stdchrono
...
int main(int argc, char** argv){
	...
	using namespace std::literals::chrono_literals; //this is to get that 's' down there
	...
	log << "TEMPO TOTAL, " << duration.count() << ", seconds" << std::endl;
